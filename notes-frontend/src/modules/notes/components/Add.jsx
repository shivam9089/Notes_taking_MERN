...
export const Add = (props)=>{
  ...
  >
    ...
    return (<>
      ...
      {errors.title && errors.title.type==='minLength' && (<p className='errorMsg'>Title minimum length is 3</p>)}
       <TextField
      // inputRef = {descr}
      {...register('descr', {validate:{
        ...
        variant="standard"
      />
      {errors.descr?.type ==='checkLength' && (<p>Min Length for Descr is 6</p>)}
      ...
      {/* <input type='date'/>
      <input type='color'/> */}
      <Button type='submit' variant="contained" color='warning'>Add Note</Button>
